 ...
 *
 * */
#define APP_VK_VERTEX_SHADER_SOURCE_PATH APP_ASSETS_SOURCE_DIR "shaders/test.vert.spv"
#define APP_VK_FRAGMENT_SHADER_SOURCE_PATH APP_ASSETS_SOURCE_DIR "shaders/test.frag.spv"
