...
bool app_vkinit_pipeline() {
  ...
  // VkVertexInputBindingDescription vi_bd = {
  //     .binding   = 0,
  //     .stride    = APP_GAME_TILE_DATA_SZ,
  //     .inputRate = VK_VERTEX_INPUT_RATE_INSTANCE,
  // };
  //
  // VkVertexInputAttributeDescription vattr_d[] = {
  //     (VkVertexInputAttributeDescription){
  //         .location = 0,
  //         .binding  = 0,
  //         .format   = APP_VK_MAIN_ATTR_COORD_FORMAT,
  //         .offset   = APP_VK_MAIN_ATTR_COORD_OFFSET,
  //     },
  //     (VkVertexInputAttributeDescription){
  //         .location = 1,
  //         .binding  = 0,
  //         .format   = APP_VK_MAIN_ATTR_COLOR_FORMAT,
  //         .offset   = APP_VK_MAIN_ATTR_COLOR_OFFSET,
  //     },
  //     (VkVertexInputAttributeDescription){
  //         .location = 2,
  //         .binding  = 0,
  //         .format   = APP_VK_MAIN_ATTR_SCALE_FORMAT,
  //         .offset   = APP_VK_MAIN_ATTR_SCALE_OFFSET,
  //     },
  //     (VkVertexInputAttributeDescription){
  //         .location = 3,
  //         .binding  = 0,
  //         .format   = APP_VK_MAIN_ATTR_ROTATION_FORMAT,
  //         .offset   = APP_VK_MAIN_ATTR_ROTATION_OFFSET,
  //     },
  //     (VkVertexInputAttributeDescription){
  //         .location = 4,
  //         .binding  = 0,
  //         .format   = APP_VK_MAIN_ATTR_TRANSLATION_FORMAT,
  //         .offset   = APP_VK_MAIN_ATTR_TRANSLATION_OFFSET,
  //     },
  //     (VkVertexInputAttributeDescription){
  //         .location = 5,
  //         .binding  = 0,
  //         .format   = APP_VK_MAIN_ATTR_TEXTUREID_FORMAT,
  //         .offset   = APP_VK_MAIN_ATTR_TEXTUREID_OFFSET,
  //     },
  // };
